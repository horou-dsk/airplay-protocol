...
impl AudioFormat {
    ...
    pub fn rate_channel(&self) -> (u32, u16) {
        match self {
            Self::Pcm8000_16_1 => (8000, 1),
            Self::Pcm8000_16_2 => (8000, 2),
            Self::Pcm16000_16_1 => (16000, 1),
            Self::Pcm16000_16_2 => (16000, 2),
            Self::Pcm24000_16_1 => (24000, 1),
            Self::Pcm24000_16_2 => (24000, 2),
            Self::Pcm32000_16_1 => (32000, 1),
            Self::Pcm32000_16_2 => (32000, 2),
            Self::Pcm44100_16_1 => (44100, 1),
            Self::Pcm44100_16_2 => (44100, 2),
            Self::Pcm44100_24_1 => (44100, 1),
            Self::Pcm44100_24_2 => (44100, 2),
            Self::Pcm48000_16_1 => (48000, 1),
            Self::Pcm48000_16_2 => (48000, 2),
            Self::Pcm48000_24_1 => (48000, 1),
            Self::Pcm48000_24_2 => (48000, 2),
            Self::Alac44100_16_2 => (44100, 2),
            Self::Alac44100_24_2 => (44100, 2),
            Self::Alac48000_16_2 => (48000, 2),
            Self::Alac48000_24_2 => (48000, 2),
            Self::AacLc44100_2 => (44100, 2),
            Self::AacLc48000_2 => (48000, 2),
            Self::AacEld44100_2 => (44100, 2),
            Self::AacEld48000_2 => (48000, 2),
            Self::AacEld16000_1 => (16000, 1),
            Self::AacEld24000_1 => (24000, 1),
            Self::Opus16000_1 => (16000, 1),
            Self::Opus24000_1 => (24000, 1),
            Self::Opus48000_1 => (48000, 1),
            Self::AacEld44100_1 => (44100, 1),
            Self::AacEld48000_1 => (48000, 1),
        }
    }
}
